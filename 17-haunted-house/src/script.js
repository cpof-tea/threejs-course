...
const doorLight = new THREE.PointLight('#ffd746', 1, 7)
doorLight.position.set(0, 2.2, 2.7)
house.add(doorLight)

const ghost = new THREE.PointLight('#ff00ff', 2, 3)
const ghost1 = new THREE.PointLight('#00ff00', 2, 3)
const ghost2 = new THREE.PointLight('#fff000', 2, 3)

scene.add(ghost, ghost2, ghost1)
...
doorLight.shadow.width = 256
doorLight.shadow.height = 256
doorLight.shadow.camera.far = 7

ghost.shadow.width = 256
ghost.shadow.height = 256
ghost.shadow.camera.far = 7

ghost1.shadow.width = 256
ghost1.shadow.height = 256
ghost1.shadow.camera.far = 7

ghost2.shadow.width = 256
ghost2.shadow.height = 256
...
const tick = () =>
{
    const elapsedTime = clock.getElapsedTime()
		...
		const ghost1Angle = - elapsedTime * 0.18
